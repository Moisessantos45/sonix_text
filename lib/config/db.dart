  ...
  try {
    ...
    Database database = await openDatabase(
      ...
      onCreate: (Database db, int version) async {
        ...
        await db.execute(
            'CREATE TABLE IF NOT EXISTS user (id TEXT PRIMARY KEY, name TEXT NOT NULL, nickname TEXT NOT NULL, level INTEGER NOT NULL,hora INTEGER DEFAULT 0,minuto INTEGER DEFAULT 0,active_notifications TEXT DEFAULT "false"),avatar TEXT');
